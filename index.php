...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>Форма входа студента</title>
  ...
  <?php
   ...
   if (isset($_POST['LOG']) && isset($_POST['PASS'])) {
    ...
    $query = "SELECT ID_S FROM `STUDENTS` WHERE `LOG` ='".$log."' AND `PASS`='".$pass."'";
  ...
  echo  "<div class='container'>
      <div class='wrapper'>
        <div class='title'><span>Студент</span></div>
        <form method='POST'>
          <div class='row'>
	  ...
	  <div class='row button'>
          ...
          <div class='signup-link'><a href='index_teacher.php'>Вход для преподавателя</a></div>
